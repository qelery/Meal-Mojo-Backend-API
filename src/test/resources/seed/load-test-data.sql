INSERT INTO address (address_id, street1, street2, street3, city, state, zipcode, country, latitude, longitude)
...
INSERT INTO users (user_id, email, password, is_active, role, customer_profile_id, merchant_profile_id)
...
INSERT INTO restaurant (restaurant_id, name, description, pickup_available, pickup_eta_minutes, delivery_available,
...
INSERT INTO menu_item (menu_item_id, name, description, price, image_url, is_available, restaurant_id)
...
INSERT INTO operating_hours (operating_hours_id, open_time, close_time, day_of_week, restaurant_id)
...
INSERT INTO orders (order_id, date_time, tip, is_completed, is_delivery, delivery_fee, payment_method, customer_profile_id, restaurant_id)
...
INSERT INTO order_line (order_line_id, quantity, price_each, menu_item_id, order_id)
VALUES (1, 2, 350, 1, 1),
       (2, 1, 659, 2, 1),
       (3, 1, 160, 3, 2),
       (4, 1, 1825, 4, 2),
